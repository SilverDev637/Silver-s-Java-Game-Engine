...
public class GraphicsUI {
	...
	private double[] anchors = new double[] {0.0, 0.0};
	
	private Graphics g;

	/**
     * Constructs a new {@code GraphicsUI} object.
    ...
    /**
     * Returns the main graphics context that stores all data and draws everything from this class.
    ...
    private int anchorX() {
        return (int) (Core.getViewportWidth() * anchors[1]);
    }

    private int anchorY() {
        return (int) (Core.getViewportHeight() * anchors[0]);
    }

    
    /**
     * Sets the anchor factors used by this GraphicsUI to translate
     * all subsequent drawing operations.
     * <p>
     * Anchors define a relative offset based on the current window size.
     * The final drawing position is computed by adding an offset equal to:
     * <pre>
     *   anchorX = windowWidth  * left
     *   anchorY = windowHeight * top
     * </pre>
     * to the coordinates provided to drawing methods.
     * <p>
     * Anchor values are expected to be in the range {@code [0.0, 1.0]},
     * where:
     * <ul>
     *   <li>{@code 0.0} represents the origin (top or left edge)</li>
     *   <li>{@code 1.0} represents the far edge (bottom or right edge)</li>
     * </ul>
     *
     * @param top  the vertical anchor factor (0.0 = top, 1.0 = bottom)
     * @param left the horizontal anchor factor (0.0 = left, 1.0 = right)
     */
    public void setAnchors(double top, double left) {
        anchors = new double[] { top, left };
    }

    /**
     * Returns the current anchor factors used by this GraphicsUI.
     * <p>
     * The returned array contains two values:
     * <ul>
     *   <li>index {@code 0}: vertical anchor ({@code top})</li>
     *   <li>index {@code 1}: horizontal anchor ({@code left})</li>
     * </ul>
     * These values represent relative offsets applied to all drawing
     * coordinates before delegating to the underlying {@link Graphics}
     * instance.
     *
     * @return a {@code double[]} containing the vertical and horizontal anchors
     */
    ...
    */
    ...
    public void clipRect(int x, int y, int width, int height) {
    	int nx = anchorX();
    	int ny = anchorY();
    	g.clipRect(x + nx, y + ny, width, height);
    }
    ...
    public void setClip(int x, int y, int width, int height) {
    	int nx = anchorX();
    	int ny = anchorY();
    	g.setClip(x + nx, y + ny, width, height);
	}
    ...
    public void copyArea(int x, int y, int width, int height,
    	...
    	int nx = anchorX();
    	int ny = anchorY();
    	g.copyArea(x + nx, y + ny, width, height, dx, dy);
	}
    ...
    public void drawLine(int x1, int y1, int x2, int y2) {
    	int nx = anchorX();
    	int ny = anchorY();
    	g.drawLine(x1 + nx, y1 + ny, x2 + nx, y2 + ny);
	}
    ...
    public void drawRect(int x, int y, int width, int height) {
    	int nx = anchorX();
    	int ny = anchorY();
        g.drawRect(x + nx, y + ny, width, height);
    }
    ...
    public void clearRect(int x, int y, int width, int height) {
    	int nx = anchorX();
    	int ny = anchorY();
    	g.clearRect(x + nx, y + ny, width, height);
	}
    ...
    public void drawRoundRect(int x, int y, int width, int height,
    	...
    	int nx = anchorX();
    	int ny = anchorY();
    	g.drawRoundRect(x + nx, y + ny, width, height, arcWidth, arcHeight);
	}
    ...
    public void fillRoundRect(int x, int y, int width, int height,
    	...
    	g.fillRoundRect(x + nx, y + ny, width, height, arcWidth, arcHeight);
	}
    ...
    public void draw3DRect(int x, int y, int width, int height,
    	...
    	int nx = anchorX();
    	int ny = anchorY();
        g.draw3DRect(x + nx, y + ny, width, height, raised);
    }
    ...
    public void fill3DRect(int x, int y, int width, int height,
    	...
    	int nx = anchorX();
    	int ny = anchorY();
        g.fill3DRect(x + nx, y + ny, width, height, raised);
    }
    ...
    public void drawOval(int x, int y, int width, int height) {
    	int nx = anchorX();
    	int ny = anchorY();
    	g.drawOval(x + nx, y + ny, width, height);
	}
    ...
    public void fillOval(int x, int y, int width, int height) {
    	int nx = anchorX();
    	int ny = anchorY();
    	g.fillOval(x + nx, y + ny, width, height);
	}
    ...
    public void drawArc(int x, int y, int width, int height,
    	...
    	int nx = anchorX();
    	int ny = anchorY();
    	g.drawArc(x + nx, y + ny, width, height, startAngle, arcAngle);
	}
    ...
    public void fillArc(int x, int y, int width, int height,
    	...
    	int nx = anchorX();
    	int ny = anchorY();
    	g.fillArc(x + nx, y + ny, width, height, startAngle, arcAngle);
	}
   ...
   public void drawString(AttributedCharacterIterator iterator,
   	...
   	int nx = anchorX();
    int ny = anchorY();
	   g.drawString(iterator, x + nx, y + ny);
	}
    ...
    public void drawChars(char[] data, int offset, int length, int x, int y) {
    	int nx = anchorX();
        int ny = anchorY();
        g.drawString(new String(data, offset, length), x + nx, y + ny);
    }
    ...
    public boolean drawImage(Image img, int x, int y,
    	...
    	int nx = anchorX();
        int ny = anchorY();
		return g.drawImage(img, x + nx, y + ny, observer);
	}
    ...
    public boolean drawImage(Image img, int x, int y,
    	...
    	int nx = anchorX();
        int ny = anchorY();
		return g.drawImage(img, x + nx, y + ny, width, height, observer);
	}
    ...
    public boolean drawImage(Image img, int x, int y,
    	...
    	int nx = anchorX();
        int ny = anchorY();
		return g.drawImage(img, x + nx, y + ny, bgcolor, observer);
	}
    ...
    public boolean drawImage(Image img, int x, int y,
    	...
    	int nx = anchorX();
        int ny = anchorY();
		return g.drawImage(img, x + nx, y + ny, width, height, bgcolor, observer);
	}
    ...
    public boolean hitClip(int x, int y, int width, int height) {
        int nx = anchorX();
        int ny = anchorY();
        return g.hitClip(x + nx, y + ny, width, height);
    }
